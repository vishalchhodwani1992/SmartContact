...
/**
 * Created by vishalchhodwani on 9/8/17.
 */
public class IMPContactRecyclerViewAdapter extends RecyclerView.Adapter<IMPContactRecyclerViewAdapter.FeedViewHolder>{

    private final String TAG = "IMPContactRecyclerViewAdapter";

    Context context;
    List<IMPContacts> feedList;
    private int position;

    public IMPContactRecyclerViewAdapter(Context context, List<IMPContacts> feedList) {
